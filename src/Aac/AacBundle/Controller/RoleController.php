...
use Aac\AacBundle\Entity\Role;
use Aac\AacBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AacBundle:Role')->findAll();
     ...
     * @Method("POST")
     * @Template("AacBundle:Role:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AacBundle:Role')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AacBundle:Role:edit.html.twig")
     */
